...
namespace SysExtensions.Collections {
    public static class CollectionExtensions {
        ...
        public static IKeyedCollection<K, V> ToKeyedCollection<K, V>(this IEnumerable<V> list, Expression<Func<V, K>> getKey,
            ...
            return new KeyedCollection<K, V>(getKey, list);
        }

        public static IKeyedCollection<K, V> ToKeyedCollection<K, V, U>(this IEnumerable<U> list, Func<U, V> getValue, Expression<Func<V, K>> getKey) {
            return new KeyedCollection<K, V>(getKey, list.Select(getValue));
        }
