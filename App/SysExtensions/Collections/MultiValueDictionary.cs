...
namespace SysExtensions.Collections {
    ...
    ///   in that getting the value for a key returns a <see cref="IReadOnlyCollection{T}" /> of values
    ...
    ** Constructors
    ...
    /// </summary>
    /// <param name="capacity">
    ///   Initial number of keys that the <see cref="MultiValueDictionary{TKey, TValue}" /> will allocate
    ///   space for
    /// </param>
    ...
    /// <remarks>
    ///   If <paramref name="comparer" /> is set to null, then the default <see cref="IEqualityComparer" /> for
    ...
    ** Static Factories
    ...
    /// </typeparam>
    /// <returns>
    ///   A new <see cref="MultiValueDictionary{TKey, TValue}" /> with the specified
    ///   parameters.
    /// </returns>
    ...
    ** Static Factories with Func parameters
    ...
    ///   A function to create a new <see cref="ICollection{TValue}" /> to use
    ///   in the internal dictionary store of this <see cref="MultiValueDictionary{TKey, TValue}" />.
    /// </param>
    /// <returns>
    ///   A new <see cref="MultiValueDictionary{TKey, TValue}" /> with the specified
    ///   parameters.
    ...
    ** Concrete Methods
    ...
    ///   <see cref="MultiValueDictionary{TKey,TValue}" />,
    ///   then <typeparamref name="TValue" /> will be added to <see cref="IReadOnlyCollection{TValue}" /> associated with
    ///   <paramref name="key" />
    /// </remarks>
    /// <remarks>
    ...
    /// <returns>
    ///   <c>true</c> if the <see cref="MultiValueDictionary{TKey,TValue}" /> contains the <paramref name="value" />;
    ///   otherwise <c>false</c>
    /// </returns>
    ...
    ** Members implemented from IReadOnlyDictionary<TKey, IReadOnlyCollection<TValue>>
    ...
    ///   <see cref="MultiValueDictionary{TKey,TValue}" /> and has
    ...
    /// <returns>
    ///   <c>true</c> if the <see cref="MultiValueDictionary{TKey,TValue}" /> contains the requested
    ...
    /// <summary>
    ///   Gets an enumerable of <see cref="IReadOnlyCollection{TValue}" /> from this
    ///   <see cref="MultiValueDictionary{TKey,TValue}" />,
    ///   where each <see cref="IReadOnlyCollection{TValue}" /> is the collection of every <typeparamref name="TValue" />
    ///   associated
    ///   with a <typeparamref name="TKey" /> present in the <see cref="MultiValueDictionary{TKey,TValue}" />.
    /// </summary>
    /// <value>
    ///   An IEnumerable of each <see cref="IReadOnlyCollection{TValue}" /> in this
    ///   <see cref="MultiValueDictionary{TKey,TValue}" />
    /// </value>
    ...
    ///   <typeparamref name="TValue" />s in this <see cref="MultiValueDictionary{TKey,TValue}" />.
    /// </exception>
    /// <value>
    ...
    /// </summary>
    /// <returns>
    ///   an Enumerator over the <typeparamref name="TKey" />-<see cref="IReadOnlyCollection{TValue}" />
    ///   pairs in this <see cref="MultiValueDictionary{TKey,TValue}" />.
    /// </returns>
