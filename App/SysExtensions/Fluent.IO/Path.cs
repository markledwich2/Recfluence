...
namespace SysExtensions.Fluent.IO {
    ...
    public class FPath : IStringConvertable, IEnumerable<FPath> {
        ...
        public string StringValue {
            ...
            set => _paths = value.UnJoin(',', escapeCharacter:'$');
        }
        ...
        public static explicit operator string(FPath path) {
            return path.FirstPath();
        }

        public static explicit operator FPath(string path) {
        ...
        public FPath Combine(FPath relativePath) {
        ...
        public FPath Copy(FPath destination) {
        ...
        /// <returns>The destination path.</returns>
        public FPath Copy(FPath destination, Overwrite overwrite) {
        ...
        public FPath Copy(FPath destination, Overwrite overwrite, bool recursive) {
        ...
        /// <returns>The destination path.</returns>
        public FPath Copy(string destination) {
        ...
        /// <param name="overwrite">Overwriting policy. Default is never.</param>
        /// <returns>The destination path.</returns>
        public FPath Copy(string destination, Overwrite overwrite) {
        ...
        /// <param name="recursive">True if the copy should be deep and include subdirectories recursively. Default is false.</param>
        /// <returns>The destination path.</returns>
        public FPath Copy(string destination, Overwrite overwrite, bool recursive) {
        ...
        /// </param>
        /// <returns>The set</returns>
        public FPath Copy(Func<FPath, FPath> pathMapping) {
        ...
        /// </param>
        /// <returns>The set</returns>
        public FPath CreateDirectories(Func<FPath, string> directoryNameGenerator) {
        ...
        /// </summary>
        /// <returns>The set</returns>
        public FPath CreateDirectories() {
        ...
        /// <returns>The set</returns>
        public FPath CreateDirectories(string directoryName) {
        ...
        public FPath CreateFile(string fileName, string fileContent) {
        ...
        /// <param name="fileContent">The content of the file.</param>
        /// <returns>A set with the created file.</returns>
        public FPath CreateFile(string fileName, byte[] fileContent) {
            return First().CreateFiles(p => Create(fileName, this), p => fileContent);
        }
        ...
        /// <returns>The set of matching subdirectories.</returns>
        public FPath Directories(string searchPattern, bool recursive) {
        ...
        public FPath Directories(Predicate<FPath> predicate) {
        ...
        /// <returns>The set of directories that satisfy the predicate.</returns>
        public FPath Directories(Predicate<FPath> predicate, bool recursive) {
        ...
        /// <summary>
        ///     Gets all the files under the directories of the set that match the pattern, going recursively into subdirectories
        ...
        public FPath Files(string searchPattern, bool recursive) {
        ...
        public FPath Files(Predicate<FPath> predicate) {
        ...
        /// <param name="recursive">True if subdirectories should be recursively included.</param>
        /// <returns>The set of paths that satisfy the predicate.</returns>
        public FPath Files(Predicate<FPath> predicate, bool recursive) {
        ...
        public FPath FileSystemEntries() {
            return FileSystemEntries(p => true, "*", false);
        }

        /// <summary>
        ///     Gets all the files and subdirectories under the directories of the set that match the pattern, going recursively
        ///     into subdirectories if recursive is set to true.
        /// </summary>
        /// <param name="searchPattern">A search pattern such as "*.jpg". Default is "*".</param>
        /// <param name="recursive">If true, subdirectories are explored as well. Default is false.</param>
        /// <returns>The set of files and folders that match the pattern.</returns>
        public FPath FileSystemEntries(string searchPattern, bool recursive) {
        ...
        public FPath FileSystemEntries(Predicate<FPath> predicate) {
        ...
        /// <param name="recursive">True if subdirectories should be recursively included.</param>
        /// <returns>The set of fils and subdirectories that satisfy the predicate.</returns>
        public FPath FileSystemEntries(Predicate<FPath> predicate, bool recursive) {
        ...
        /// <returns>The set</returns>
        public FPath Grep(string regularExpression, Action<FPath, Match, string> action) {
            return Grep(new Regex(regularExpression, RegexOptions.Multiline), action);
        }
        ...
        /// <returns>The set of relative paths.</returns>
        public FPath MakeRelativeTo(string parent) {
        ...
        ///     Makes each path relative to the provided one.
        /// </summary>
        /// <param name="parentGenerator">
        ///     A function that returns a path to which the new one is relative to for each of the paths
        ///     in the set.
        /// </param>
        /// <returns>The set of relative paths.</returns>
        ...
        /// <param name="overwrite">Overwriting policy. Default is never.</param>
        /// <returns>The destination path.</returns>
        public FPath Move(string destination, Overwrite overwrite) {
        ...
        public FPath Move(Func<FPath, FPath> pathMapping) {
        ...
        /// <returns>The set</returns>
        public FPath Open(Action<FileStream> action) {
        ...
        /// <param name="action">The action to perform on the open streams.</param>
        /// <returns>The set</returns>
        public FPath Open(Action<FileStream, FPath> action) {
            return Open(action, FileMode.OpenOrCreate, FileAccess.ReadWrite, FileShare.None);
        }
        ...
        /// <returns>The set.</returns>
        public FPath Process(Func<string, string> processFunction) {
        ...
        /// <param name="processFunction">The processing function.</param>
        /// <returns>The set.</returns>
        public FPath Process(Func<byte[], byte[]> processFunction) {
            return Process((p, s) => processFunction(s));
        }
        ...
        /// <returns>The set</returns>
        public FPath Read(Action<string> action) {
        ...
        /// <param name="encoding">The encoding to use when reading the file.</param>
        /// <returns>The set</returns>
        public FPath Read(Action<string> action, Encoding encoding) {
        ...
        /// <returns>The set</returns>
        public FPath ReadBytes(Action<byte[]> action) {
        ...
        public FPath Add(params string[] paths) {
        ...
        /// <param name="paths">The paths to add to the current set.</param>
        /// <returns>The composite set.</returns>
        public FPath Add(params FPath[] paths) {
        ...
        /// <returns>The attributes</returns>
        public FPath Attributes(Action<FileAttributes> action) {
        ...
        /// <returns>The set</returns>
        public FPath Attributes(FileAttributes attributes) {
        ...
        /// <returns>The set</returns>
        public FPath CreationTime(DateTime creationTime) {
        ...
        /// <returns>The set</returns>
        public FPath CreationTimeUtc(DateTime creationTimeUtc) {
        ...
        /// <returns>The set</returns>
        public FPath LastAccessTime(DateTime lastAccessTime) {
        ...
        /// <returns>The set</returns>
        public FPath LastAccessTimeUtc(DateTime lastAccessTimeUtc) {
        ...
        /// <returns>The set</returns>
        public FPath LastWriteTime(DateTime lastWriteTime) {
        ...
        /// <returns>The set</returns>
        public FPath LastWriteTimeUtc(DateTime lastWriteTimeUtc) {
        ...
        /// <returns>The set</returns>
        public FPath Write(string text) {
        ...
        /// <returns>The set</returns>
        public FPath Write(string text, bool append) {
        ...
        /// <param name="encoding">The encoding to use.</param>
        /// <returns>The set</returns>
        public FPath Write(string text, Encoding encoding) {
        ...
        /// <param name="append">True if the text should be appended to the existing content. Default is false.</param>
        /// <returns>The set</returns>
        public FPath Write(string text, Encoding encoding, bool append) {
        ...
        /// <param name="append">True if the text should be appended to the existing content. Default is false.</param>
        /// <returns>The set</returns>
        public FPath Write(Func<FPath, string> textFunction, bool append) {
            return Write(textFunction, Encoding.GetEncoding("utf-8"), append);
        }
        ...
        protected static FPath Create(IEnumerable<string> paths, FPath previousPaths) {
            return new FPath {_paths = paths, _previousPaths = previousPaths};
        }

        protected static FPath Create(IEnumerable<FPath> paths) {
            return Create(paths.SelectMany(p => p._paths), null);
        }

        protected static FPath Create(IEnumerable<string> paths) {
            return Create(paths, null);
        }

        protected static FPath Create(params string[] paths) {
            return Create((IEnumerable<string>) paths);
        }

        protected static FPath Create() {
            return Create(new string[] { });
        }

        protected static FPath Create(params FPath[] paths) {
            return Create((IEnumerable<FPath>) paths);
        }

        protected static FPath Create(string path) {
            return Create(path, (FPath) null);
        }

        protected static FPath Create(string path, FPath previousPaths) {
            return new FPath {_paths = new[] {path}, _previousPaths = previousPaths};
        }
