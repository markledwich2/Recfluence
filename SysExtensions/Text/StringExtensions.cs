...
namespace SysExtensions.Text {
    public static class StringExtensions {
        ...
        public static TextReader AsTextStream(this string content) {
        ...
        public static byte[] ToBytesFromBase64(this string s) {
        ...
        public static string ToStringFromUtf8(this byte[] b) {
            return Encoding.UTF8.GetString(b);
        }

        public static string Hash(this string content) {
            return _hash.ComputeHash(content.ToBytesUtf8()).ToBase64String();
        }

        public static string SurroundWith(this string s, string prefix, string suffix) {
        ...
        /// </summary>
        public static string Text(this bool b, string trueString, string falseString = "") {
