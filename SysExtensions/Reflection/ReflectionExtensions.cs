...
namespace SysExtensions.Reflection {
    ...
    public static class ReflectionExtensions {
        ...
        /// </summary>
        public static void CopyPropertiesFrom<T>(this T to, object from, CopyPropertiesBehaviour behaviour = CopyPropertiesBehaviour.CopyAll) where T : class {
            foreach (var toProp in to.GetType().GetProperties()) {
                ...
                if (toProp.PropertyType.GetTypeInfo().IsGenericType && typeof(ICollection<>).IsAssignableFrom(toProp.PropertyType.GetGenericTypeDefinition())
        ...
        public static IEnumerable<Type> ImplementingTypes<T>(this Assembly assembly) where T : class {
            return assembly.ExportedTypes.Where(t => IsCreatable(t) && typeof(T).IsAssignableFrom(t));
        }
        ...
        public static bool IsCollection(this Type type) {
            return type.ImplementsGenericDefinition(typeof(ICollection<>));
        }

        public static bool IsEnumerable(this Type type) { return typeof(IEnumerable).IsAssignableFrom(type); }
        ...
        static void SetValue<T>(T to, object from, PropertyInfo toProp) where T : class { toProp.SetValue(to, toProp.GetValue(from, null), null); }

        public static object GetPropValue(this object o, string propName) { return o.GetType().GetProperty(propName).GetValue(o); }

        public static T GetPropValue<T>(this object o, string propName) { return (T) o.GetPropValue(propName); }
